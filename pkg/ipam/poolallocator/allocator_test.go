...
// Race will be detected with race detector in this test due to asynchronous nature of informer, // however race is not an issue here since testingclient validates version consistency during
// update
