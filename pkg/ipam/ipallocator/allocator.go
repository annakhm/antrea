...
// Allocate continuous range of specified size. If not available, error is returned.
...
// Allocate continuous range of specified size. If not available in any allocator, error is returned.
